...
request({url, json: true}, (error, {body}) => {
  if(error){
    ...
    callback(undefined, "It is " + body.current.weather_descriptions[0]  + ", it is " + body.current.temperature + " degrees outside, it feels like " + body.current.feelslike + " degrees")
